...
The `analysis` block is refreshed manually (via a Claude/Cowork session doing
live web research), not by a GitHub Actions job — an earlier attempt at fully
automating it via the Anthropic API was removed to avoid the ongoing API
